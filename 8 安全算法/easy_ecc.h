...
int ecdsa_verify(const uint8_t p_publicKey[ECC_BYTES+1], const uint8_t p_hash[ECC_BYTES], const uint8_t p_signature[ECC_BYTES*2]);
 ...
 //* expand API */////////////
/////////////////////////////
int easy_ecc_gen_key(uint8_t p_publicKey[64], uint8_t p_privateKey[32]);
...
int easy_ecdh_shared_secret(const uint8_t p_publicKey[64], const uint8_t p_privateKey[32], uint8_t p_secret[32]);
